    ...
    return (
        <>
            ...
            <button
                ...
                className={`flex items-center gap-2 px-4 py-1 rounded-lg transition cursor-pointer
        ${liked ? "bg-red-100 text-red-600" : "bg-gray-100 text-gray-700 border border-gray-300 hover:bg-gray-200"} `}>
            ...
            <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-transform duration-150 active:scale-95 cursor-pointer
